...
# 生成指定队形
origin_formation = generate_circle_points(leader_point = [0,0,0], num_points = 55, direction= [1,0,0], spacing= 3)
...
origin_formation = np.delete(origin_formation,11,0)
origin_formation = np.delete(origin_formation,21,0)
origin_formation = np.delete(origin_formation,31,0)
origin_formation = np.delete(origin_formation,25,0)
# 随机生成队形
# size = 10
# random.seed(42)
# for i in range(size):
