...
# 手动选择点的索引
marker_indices = [0, 1295, 2590,3749]
...
for idx, file_name in enumerate(file_names):
    try:
        ...
        ax.scatter(x[valid_indices], y[valid_indices], color=colors[idx], label=f'Node {idx}', s=35, zorder=5)
...
# 调整布局并显示
plt.tight_layout()
output_path = f"utils\show\{dir}.png"  # 文件保存路径
